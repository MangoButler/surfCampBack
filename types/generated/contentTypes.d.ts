...
export interface ApiBlogArticleBlogArticle extends Schema.CollectionType {
  ...
  attributes: {
    ...
    author: Attribute.String &
      Attribute.Required &
      Attribute.DefaultTo<'Jimmy the Surfer'>;
    isHighlightedArticle: Attribute.Boolean &
      Attribute.Required &
      Attribute.DefaultTo<false>;
    ...
    >;
    headlineIsBlack: Attribute.Boolean &
      Attribute.Required &
...
export interface ApiInfoblockInfoblock extends Schema.CollectionType {
  collectionName: 'infoblocks';
  info: {
    singularName: 'infoblock';
    pluralName: 'infoblocks';
...
declare module '@strapi/strapi' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::infoblock.infoblock': ApiInfoblockInfoblock;
